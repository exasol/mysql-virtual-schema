...
class MySQLSqlDialectIT {
        ...
        private static void createMySqlSimpleTable(final Schema mySqlSchema) {
                final Table table = mySqlSchema.createTable(MYSQL_SIMPLE_TABLE,
                                List.of("int_col", "bool_col", "varchar_col"),
        ...
        private static void createMySqlNumericDateTable(final Schema mySqlSchema) {
                final Table table = mySqlSchema.createTable(MYSQL_NUMERIC_DATE_DATATYPES_TABLE,
                                List.of("BiT_Col", "tinyint_col", "BOOL_COL", "smallint_col", "mediumint_col",
                                                "int_col", "bigint_col", "decimal_col", "float_col", "double_col", //
                                                "date_col", "datetime_col", "timestamp_col", "time_col", "year_col"),
                                List.of("BIT(6)", "TINYINT", "BOOLEAN", "SMALLINT", "MEDIUMINT", "INT", "BIGINT",
                                                "DECIMAL(5, 2)", "FLOAT(7, 4)", "DOUBLE", //
                                                "DATE", "DATETIME", "TIMESTAMP", "TIME", "YEAR"));
                table.insert("5", 127, 1, 32767, 8388607, 2147483647, 9223372036854775807L, 999.99, 999.00009,
                                999.00009, //
                                "1000-01-01", "1000-01-01 00:00:00", "1970-01-01 00:00:01.000000", "16:59:59.000000",
                                1901);
                table.insert("9", -127, 0, -32768, -8388608, -2147483648, -9223372036854775808L, -999.99, -999.9999,
                                -999.9999, //
                                "9999-12-31", "9999-12-31 22:59:59", "2037-01-19 03:14:07.999999", "05:34:13.000000",
                                2155);
        ...
        private static void createMySqlStringTable(final Schema mySqlSchema) {
                final Table table = mySqlSchema.createTable(MYSQL_STRING_DATATYPES_TABLE,
                                List.of("binary_col", "varbinary_col", "tinyblob_col", "tinytext_col", "blob_col",
                                                "text_col", "mediumblob_col", "mediumtext_col", "longblob_col",
                                                "longtext_col", "enum_col", "set_col", "varchar_col", "char_col"),
                                List.of(" BINARY(20)", "VARBINARY(20)", "TINYBLOB", "TINYTEXT", "BLOB", "TEXT",
                                                "MEDIUMBLOB", "MEDIUMTEXT", "LONGBLOB", "LONGTEXT",
                                                "ENUM('1', '2', '3')", "SET('1')", "VARCHAR(16000)", "CHAR(255)"));
                table.insert("a", "a", "a", "a", "blob", "text", "mediumblob", "mediumtext", "longblob", "longtext",
                                "1", "1", "ab", "asd24");
                table.insert("a\0", "a\0", "aa", "b", "blob", "text2", "mediumblob2", "mediumtext2", "longblob",
                                "longtext2", "2", "1", "a", "11111");
                table.insert(null, null, "aaa", "aaaaaaaaaaaaa", "bloooooooooooob", "text3", null, null, null, null,
                                "3", null, "", "");
        ...
        private boolean runCharsetTest() {
                ...
                final Version version = Version.of(dockerImage.getMajor(), dockerImage.getMinor(),
        ...
        private void createMySqlTableContainingCharAndEnumWithCharacterSet(final String schemaName,
                        final String tableName, final String characterSet) {
        ...
        private static MySqlSchema getSchemaWithCharacterSet(final String schemaName, final String characterSet) {
                return new MySqlSchema(SETUP.getTableWriterWithCharacterSet(characterSet),
                                MySQLIdentifier.of(schemaName));
        }
        ...
        void testComparisonPredicates() throws SQLException {
                ...
                final ResultSet expected = getExpectedResultSet(
                                List.of("int_col DECIMAL(10,0)", "b1 BOOLEAN", "b2 BOOLEAN", "b3 BOOLEAN", "b4 BOOLEAN",
                                                "b5 BOOLEAN", "b6 BOOLEAN"), //
        ...
        void testLikePredicates() throws SQLException {
                final String query = "SELECT \"varchar_col\", \"varchar_col\" LIKE 'a%' ESCAPE 'a' FROM "
                                + virtualSchemaJdbc + "." + MYSQL_SIMPLE_TABLE + " WHERE (\"varchar_col\" LIKE 'a%')";
        ...
        void testMiscPredicates() throws SQLException {
                final String query = "SELECT \"int_col\", \"int_col\" in (56, 61), \"int_col\" is null, \"int_col\" != null"
                                + " FROM " + virtualSchemaJdbc + "." + MYSQL_SIMPLE_TABLE
                                + " WHERE \"int_col\" between -10 and 51";
                final ResultSet expected = getExpectedResultSet(
        ...
        void testCountSumAggregateFunction() throws SQLException {
                ...
                final ResultSet expected = getExpectedResultSet(List.of("a DECIMAL(10,0)", "b DECIMAL(10,0)",
                                "c DECIMAL(10,0)", "d DECIMAL(19,0)", "e DECIMAL(19,0)"), List.of("6, 6, 6, 59, 59"));
                assertThat(getActualResultSet(query), matchesResultSet(expected));
        }

        @Test
        void testAvgMinMaxAggregateFunction() throws SQLException {
                final String query = "SELECT AVG(\"int_col\"), MIN(\"int_col\"), MAX(\"int_col\") FROM "
        ...
        void testOrderByLimit() throws SQLException {
                final String query = "SELECT \"bool_col\", \"int_col\" FROM " + virtualSchemaJdbc + "."
                                + MYSQL_SIMPLE_TABLE + " ORDER BY \"int_col\" LIMIT 3";
        ...
        void testOrderByLimitOffset() throws SQLException {
                final String query = "SELECT \"bool_col\", \"int_col\" FROM " + virtualSchemaJdbc + "."
                                + MYSQL_SIMPLE_TABLE + " ORDER BY \"int_col\" LIMIT 2 OFFSET 1";
                final ResultSet expected = getExpectedResultSet(List.of("a BOOLEAN", "b DECIMAL(10,0)"), //
                                List.of("false, -1", //
                                                "true, 0"));
                assertThat(getActualResultSet(query), matchesResultSet(expected));
        ...
        void testLeftShiftScalarFunction() {
                createSourceTable(List.of("INT_COL_1", "INT_COL_2"), List.of("INT", "INT"),
                                new Object[][] { { 10, 3 } });
        ...
        private void createSourceTable(final List<String> columnNames, final List<String> types,
                        final Object[][] values) {
        ...
        void testHourScalarFunction() {
                createSourceTable(List.of("TIMESTAMP_COL"), List.of("TIMESTAMP"),
                                new Object[][] { { "2021-02-16 11:48:01" } });
                this.virtualSchema = SETUP.createVirtualSchema(Collections.emptyMap(), MYSQL_SOURCE_SCHEMA);
        ...
        class DatatypeTest {
                ...
                void testTimestamp() throws SQLException {
                        final String query = "SELECT \"timestamp_col\" FROM " + virtualSchemaJdbc + "."
                                        + MYSQL_NUMERIC_DATE_DATATYPES_TABLE;
                        final ResultSet expected = getExpectedResultSet(List.of("col1 TIMESTAMP"), //
                                        List.of("'1970-01-01 00:00:01.000000'", "'2037-01-19 03:14:08.0'", "null",
                                                        "null"));
                        assertThat(getActualResultSet(query), matchesResultSet(expected));
                }
                ...
                void testTime() throws SQLException {
                        final String query = "SELECT \"time_col\" FROM " + virtualSchemaJdbc + "."
                                        + MYSQL_NUMERIC_DATE_DATATYPES_TABLE;
                        final ResultSet expected = getExpectedResultSet(List.of("col1 TIMESTAMP"), //
                                        List.of("'1970-01-01 16:59:59.000000'", "'1970-01-01 05:34:13.000000'", "null",
                                                        "null"));
                        assertThat(getActualResultSet(query), matchesResultSet(expected));
                }
                ...
                void testText() throws SQLException {
                        final String query = "SELECT \"text_col\" FROM " + virtualSchemaJdbc + "."
                                        + MYSQL_STRING_DATATYPES_TABLE;
                ...
                void testEnum() throws SQLException {
                        final String query = "SELECT \"enum_col\" FROM " + virtualSchemaJdbc + "."
                                        + MYSQL_STRING_DATATYPES_TABLE;
                ...
                void testSet() throws SQLException {
                        final String query = "SELECT \"set_col\" FROM " + virtualSchemaJdbc + "."
                                        + MYSQL_STRING_DATATYPES_TABLE;
                        final ResultSet expected = getExpectedResultSet(List.of("col1 CHAR"), //
                ...
                void testChar() throws SQLException {
                        final String query = "SELECT \"char_col\" FROM " + virtualSchemaJdbc + "."
                                        + MYSQL_STRING_DATATYPES_TABLE;
        ...
        class JoinTest {
                ...
                void testInnerJoin() throws SQLException {
                        final String query = "SELECT * FROM " + virtualSchemaJdbc + "." + TABLE_JOIN_1
                                        + " a INNER JOIN  " + virtualSchemaJdbc + "." + TABLE_JOIN_2
                                        + " b ON a.\"x\"=b.\"x\"";
                        final ResultSet expected = getExpectedResultSet(
                ...
                void testInnerJoinWithProjection() throws SQLException {
                        final String query = "SELECT b.\"y\" || " + virtualSchemaJdbc + "." + TABLE_JOIN_1
                                        + ".\"y\" FROM " + virtualSchemaJdbc + "." + TABLE_JOIN_1 + " INNER JOIN  "
                                        + virtualSchemaJdbc + "." + TABLE_JOIN_2 + " b ON " + virtualSchemaJdbc + "."
                                        + TABLE_JOIN_1 + ".\"x\"=b.\"x\"";
                ...
                void testLeftJoin() throws SQLException {
                        final String query = "SELECT * FROM " + virtualSchemaJdbc + "." + TABLE_JOIN_1
                                        + " a LEFT OUTER JOIN " + virtualSchemaJdbc + "." + TABLE_JOIN_2
                ...
                void testRightJoin() throws SQLException {
                        final String query = "SELECT * FROM " + virtualSchemaJdbc + "." + TABLE_JOIN_1
                                        + " a RIGHT OUTER JOIN " + virtualSchemaJdbc + "." + TABLE_JOIN_2
                                        + " b ON a.\"x\"=b.\"x\" ORDER BY a.\"x\"";
                        final ResultSet expected = getExpectedResultSet(
                                        List.of("x INT", "y VARCHAR(100)", "a INT", "b VARCHAR(100)"), //
                ...
                void testFullOuterJoin() throws SQLException {
                        final String query = "SELECT * FROM " + virtualSchemaJdbc + "." + TABLE_JOIN_1
                                        + " a FULL OUTER JOIN " + virtualSchemaJdbc + "." + TABLE_JOIN_2
                                        + " b ON a.\"x\"=b.\"x\" ORDER BY a.\"x\"";
                        final ResultSet expected = getExpectedResultSet(
                                        List.of("x INT", "y VARCHAR(100)", "a INT", "b VARCHAR(100)"), //
                                        List.of("1, 'aaa', null, null", //
