...
public final class IntegrationTestConstants {
    public static final String VIRTUAL_SCHEMAS_JAR_NAME_AND_VERSION = "virtual-schema-dist-8.0.0-mysql-1.0.0.jar";
    public static final String EXASOL_DOCKER_IMAGE_REFERENCE = "exasol/docker-db:7.0.2";
    public static final String MYSQL_DOCKER_IMAGE_REFERENCE = "mysql:8.0.20";
