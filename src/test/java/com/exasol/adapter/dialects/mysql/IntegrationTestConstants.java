...
public final class IntegrationTestConstants {
    ...
    public static final String EXASOL_DOCKER_IMAGE_REFERENCE = "7.1.14"; // "7.0.7";
    public static final String MYSQL_DOCKER_IMAGE_REFERENCE = "mysql:8.0.30"; // "mysql:8.0.23";
