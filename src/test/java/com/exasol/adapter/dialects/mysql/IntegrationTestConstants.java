...
public final class IntegrationTestConstants {
    public static final String VIRTUAL_SCHEMAS_JAR_NAME_AND_VERSION = "virtual-schema-dist-11.0.2-mysql-4.1.4.jar";
//    public static final String EXASOL_DOCKER_IMAGE_REFERENCE = "7.1.22";
    public static final String EXASOL_DOCKER_IMAGE_REFERENCE = "7.1.18";
